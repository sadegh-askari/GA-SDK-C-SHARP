...
namespace GameAnalyticsSDK.Net.Device
{
	...
	{
#if WINDOWS_UWP
        private const string _sdkWrapperVersion = "uwp 3.3.5";
#elif WINDOWS_WSA
        private const string _sdkWrapperVersion = "wsa 3.3.5";
#else
...
#endif
        private static string _osVersion => GetOSVersionString();
#if WINDOWS_UWP || WINDOWS_WSA
		...
		{
			string osVersion = SystemInfo.operatingSystem.ToLower();
        ...
        {
            string result = Application.persistentDataPath + Path.DirectorySeparatorChar + "GameAnalytics";// Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + Path.DirectorySeparatorChar + "GameAnalytics" + Path.DirectorySeparatorChar + System.AppDomain.CurrentDomain.FriendlyName;
